...
int main() {
    ...
    cout<<"\n---- Example 3: for loop as a increment counter with different steps ----- "<<endl;
    ...
    // print all number between -10 and 10, that are multiple of 3
    for(int p = -10; p <=10; p++) {
        if(p%3==0 && p!=0) {
            cout<<p<<"\t";
        }
    ...
    //print result
    cout<<"Ther is/are "<<even_count<<" even number/s"<<endl;
